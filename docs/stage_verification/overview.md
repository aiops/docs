...
| ID  | Timestamp | Level | Log message                         | State                        | Change |  A  |  B  |  Risk  |
|-----|:---------:|-------|-------------------------------------|------------------------------|:------:|:---:|:---:|:------:|
| 1   |   08h21   | INFO  | Customer id=111-222 data stored     | Customer id=$1 data stored   |   +8%  | Yes | Yes |  None  |
| 2   |   08h22   | INFO  | Processing request req=A12-345      | Processing request req=$1    |  -34%  | Yes | Yes |   Low  |
| 3   |   08h24   | WARN  | Retrying (#15) request req=A22-222  | Retrying ($1) request req=$2 |  +162% | Yes | Yes | Medium |
| 4   |   08h31   | WARN  | Cannot connect to: 192.168.0.1:9090 | Unable to connect to: $1:$2  |   +12  |  No | Yes |  High  |
| 5   |   08h35   | ERROR | Insufficient memory (64GB)          | Insufficient memory ($1)     |   -7   | Yes |  No |  None  |
